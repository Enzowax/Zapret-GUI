...
- **Простой** — один экран. Большие кнопки **Запустить / Остановить**, «здоровье»
  Discord / YouTube / Google, Telegram в один клик, кнопка **«Подобрать и
  включить»** (сама найдёт рабочую стратегию и запустит), а также самое нужное
  новичку: свои сайты для обхода, переключатель **«Не трогать Steam / Dota 2»**,
  выбор темы и автозапуск с Windows. Поставил, нажал — работает.

...
- **Простой** — один экран. Большие кнопки **Запустить / Остановить**, «здоровье»
  Discord / YouTube / Google, Telegram в один клик и кнопка **«Подобрать и
  включить»** (сама найдёт рабочую стратегию и запустит). Для тех, кто не хочет
  разбираться: поставил, нажал — работает.
